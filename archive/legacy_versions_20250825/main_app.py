...
# 導入新的架構組件
from src.ui.components.layout.main_layout import MainLayout
from src.ui.components.knowledge_base.upload_zone import UploadZone
from src.ui.components.chat.chat_interface import ChatInterface

# 導入系統核心
from src.utils.utils import get_rag_system  # 使用工廠函式
